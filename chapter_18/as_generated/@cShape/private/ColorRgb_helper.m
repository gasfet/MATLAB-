...
%COLORRGB_HELPER for class cShape, Replace with a short note that will appear
...
switch which
    ...
    case 'set'  % MUTATOR
        ...
        %     [this.ColorRgb] = deal(varargin{:});
        % else  % deeper indexing requested, use subsasgn to do it
        %     ColorRgb = [this.ColorRgb];  % Modify the assignment
        %     ColorRgb = subsasgn(ColorRgb, index, varargin{:});
