...
%LINEWIDTH_HELPER for class cLineStyle, Replace with a short note that will
%                 appear on the H1 line along with each function description
%
...
switch which
    ...
    case 'set'  % MUTATOR
        ...
        %     [this.LineWidth] = deal(varargin{:});
        % else  % deeper indexing requested, use subsasgn to do it
        %     LineWidth = [this.LineWidth];  % Modify the assignment
        %     LineWidth = subsasgn(LineWidth, index, varargin{:});
