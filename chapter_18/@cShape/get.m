...
%GET for class cShape, Replace with a short note that will appear on the H1
...
switch index(1).subs
    ...
    case 'ColorRgb'
        if isempty(this)
            ...
            [do_sub_indexing, do_assignin, this, varargout{:}] = ...
                ColorRgb_helper('get', this, [index(2:end) varargin{:}]);
        end
    case 'Points'
        if isempty(this)
            varargout = {};
    ...
    case 'LineWeight'
        if isempty(this)
            ...
            % either index(2:end) or varargin{1} should be empty
            [do_sub_indexing, do_assignin, this, varargout{:}] = ...
                LineWeight_helper('get', this, [index(2:end) varargin{:}]);
        end
    otherwise
